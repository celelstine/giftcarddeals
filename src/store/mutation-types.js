...
export const SEND_ADMIN_FEEDBACK_FAILURE = 'SEND_ADMIN_FEEDBACK_FAILURE';
export const SENT_ADMIN_FEEDBACK = 'SENT_ADMIN_FEEDBACK';
export const SENDING_ADMIN_FEEDBACK = 'SENDING_ADMIN_FEEDBACK';
