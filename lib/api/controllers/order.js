...
module.exports = {
  ...
  placeOrder1: function placeOrder1(req, res, next) {
    // create object from request
    ...
    if (!(0, _validators.isValidAccountNumber)(bankAccountNumber)) {
      inputValidationMessage += '*Please provide a valid Account Number (10 digits)\n';
    }
    if (!(0, _validators.isValidFullName)(bankAccountName)) {
  ...
  homepage: function homepage(req, res) {
    ...
    var message = res.locals.message || null;
