...
var _utility = require('./api/controllers/utility');
...
var giftcardsPath = _path2.default.join(__dirname, 'giftcards/');
app.use('/nngiftCards', _express2.default.static(giftcardsPath));

// for nuxt static link to nuxt home page
app.use('/Home', _express2.default.static(publicPath));
var homePageLink = _path2.default.join(__dirname, 'dist/Home');
app.use('*', _express2.default.static(homePageLink));
